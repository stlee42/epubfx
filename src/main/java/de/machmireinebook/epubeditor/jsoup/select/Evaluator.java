package de.machmireinebook.epubeditor.jsoup.select;
...
public abstract class Evaluator {
     ...
     */
    public static final class AttributeEvaluator extends Evaluator {
        private String key;

        public AttributeEvaluator(String key) {
            this.key = key;
        }
     ...
     * 
     * @see de.machmireinebook.epubeditor.jsoup.select.Evaluator.IndexEquals
     */
