...
import de.machmireinebook.epubeditor.htmlcleaner.ContentNode;
import de.machmireinebook.epubeditor.htmlcleaner.Display;
import de.machmireinebook.epubeditor.htmlcleaner.ITagInfoProvider;
import de.machmireinebook.epubeditor.htmlcleaner.TagInfo;
import de.machmireinebook.epubeditor.htmlcleaner.TagNode;

import static de.machmireinebook.epubeditor.htmlcleaner.Utils.isEmptyString;
...
public class TagNodeEmptyContentCondition implements ITagNodeCondition {
    ...
    private boolean satisfy(TagNode tagNode, boolean override) {
        ...
        if (tagInfo != null && !hasIdAttributeSet(tagNode) && Display.none != tagInfo.getDisplay() && !tagInfo.isEmptyTag() && (override || !unsafeBlockElements.contains(name))) {
