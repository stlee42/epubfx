package de.machmireinebook.epubeditor.epublib.html.htmlcleaner;
...
import de.machmireinebook.commons.htmlcleaner.CommentNode;
import de.machmireinebook.commons.htmlcleaner.ContentNode;
import de.machmireinebook.commons.htmlcleaner.EndTagToken;
...
//		
    ...
    protected void serializeEmptyTag(TagNode tagNode, XMLStreamWriter writer) throws XMLStreamException {
        ...
        Map tagAtttributes = tagNode.getAttributes();
        for (Object o : tagAtttributes.entrySet())
        {
	...
	private void serializeToken(Object item, XMLStreamWriter writer) throws XMLStreamException {
        if ( item instanceof ContentNode) {
            writer.writeCharacters(((ContentNode) item).getContent());
        } else if(item instanceof CommentNode) {
			writer.writeComment(((CommentNode) item).getContent());
